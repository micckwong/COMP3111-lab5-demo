	...
	public List<Item> scrape(String keyword) {
		...
		try {
			...
			for (int i = 0; i < items.size(); i++) {
				...
				//System.out.println("[scrape log]: " + itemAnchor.getHrefAttribute());
				
				/* This is the default one given by the TA, error is identified and changed to the line below */
